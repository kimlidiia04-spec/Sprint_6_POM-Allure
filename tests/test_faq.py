...
class TestFAQ:
    ...
    @allure.title("Проверка соответствия вопроса и ответа: {question_name}")
    def test_faq_answers(self, driver, question_name, question_locator, answer_locator, expected_answer):
